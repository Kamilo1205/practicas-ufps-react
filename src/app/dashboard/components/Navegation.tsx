        ...
        <div className="p-3">
          ...
          <nav className="mt-6">
            ...
            <ul>
              ...
              <li>
                <Item label="Solicitud de Practicantes" icon={HiOutlineEnvelope} to="solicitudes-de-practicantes" />
              </li>               
            </ul>
          </nav>
          ...
          <nav className="mt-6">
            ...
            <ul>
              <li>
                <Item label="Practicantes" icon={HiOutlineUsers} to="empresa/racticantes" />
              </li>
              <li>
                <Item label="Tutores Empresariales" icon={HiOutlineAcademicCap} to="empresa/tutores-empresariales" />
              </li>
              <li>
                <Item label="Solicitud de Practicantes" icon={HiOutlineEnvelope} to="empresa/solicitudes-de-practicantes" />
              </li>               
            </ul>
          </nav>
          ...
          <nav className="mt-6">
            ...
            <ul>
              <li>
                <Item label="Empresa" icon={HiOutlineBriefcase} to="estudiante/empresa" />
              </li>               
            </ul>
          </nav>
